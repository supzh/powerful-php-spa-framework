...
class Mailer
{
	...
	public static function sendExcpetion(\Exception $e, $method)
	{
		$appConfig = config('app');
        $subject = $appConfig['name'].'('.$appConfig['env'].')'.'['.$appConfig['node'].']'.$method;
		static::send($subject, (string)$e, getenv('MAILER_ERR_REPORT_TO'));
	}
